...
- [Dice] are the number **Magic Dice** invested in the spell.
- [Sum] equals the sum of rolled **Magic Dice**.
- An **item** is anything you can lift with one hand, and an **object** is anything up to human-sized.
- Unless otherwise noted, all spells with ongoing effects last up to [sum]×10 minutes and range up to 40 feet.

## Spells

| d100 | Spell | Description|
| :-: | - | - |
| 1 | **Adhere** | [Dice] objects are covered in extremely sticky slime. |
| 2 | **Anchor** | A strong wire sprouts from your arms, affixing itself to [dice] points within 50ft on each side. |
| 3 | **Animate Object** | [Dice] objects obey your commands as best they can. It can walk 15 feet per round. |
| 4 | **Anthropomorphize** | A touched animal gains either human intelligence or appearance for [sum] days. |
...
| 12 | **Befuddle** | [Sum] creatures of your choice cannot form new short-term memories for the spell's duration. |
| 13 | **Body Swap** | You switch bodies with a creature you touch. If one body dies, the other dies as well. |
| 14 | **Charm** | [Sum] creatures treat you as though you are a friend. |
...
| 21 | **Deafen** | [sum] nearby creatures are deafened. |
...
| 29 | **Flare** | A bright ball of energy fires a light trail into the sky, revealing your location to friend and foe for [dice] minutes. |
...
| 48 | **Magic Dampener** | [Dice] nearby magical effects have halved effectiveness. |
...
| 54 | **Mirrorwalk** | A mirror becomes a gateway to another mirror you looked into today. |
...
| 79 | **Sort** | Inanimate items are sorted according to your categories.|
| 80 | **Spectacle** | A clearly unreal but impressive illusion of your choice appears under your control for [dice] minutes. It may be up to the size of a palace and has full motion and sound |
...
| 83 | **Summon Cube** | [Sum] times per round, you may summon or banish a 3-foot-wide cube of earth. New cubes must be affixed to the earth or other cubes. |
...
| 98 | **Widget** | A primitive version of a drawn tool or item appears before you and disappears after [dice] minutes. |
