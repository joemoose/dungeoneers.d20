...
- Sling (d6)
- Hand Axe (d6)
- Repellent (choose a creature, 3 uses)
...
| **2** | A crop spirit, angered by a poor tithing. The fires consumed nearly everything, and afterward, you gathered a pouch of **Fireseeds** (d8, *blast*, 4 uses). |
...
| **4** | *The Withering*, a type of stem rot from underdark. Take a **Diseased Crop** (6 uses) that quickly decays any plant it touches. |
...
| **6** | Crop thieves. Not all of them survived, but you were outnumbered. Take a +d4 HP and a **Hilted Broadsword** (d8/d8+d8). |
...
| **2** | **Clatter Keeper** | A hand-cranked device that emits a loud, piercing noise that frightens away most creatures. |
...
| **5** | **Greenwhistle** | A small flute that calms plants, making passage through areas heavy with plant life easier. |
| **6** | **Everbloom Band** | A circlet adorned with flowers that never wilt. On failing a **Critical Damage** roll, the flowers dissolve into dust, but you continue as if your save succeeded. |
