...
You strike from afar, but that does not make you a coward. You are a musician; the song of your bowstring is naught but a warning, singing the silent promise of a quick death. 
...
- Heartroot Salve (recover d4 attribute loss)
...
| **5** | **Training**. If you are the first to attack, melee attacks against you are *impaired* until you take STR *or* DEX damage. |
...
| **3** | **Stone Pine** (d6, *bulky*). Produces explosive **Sticky Sap** once per day. |
| **4** | **White Ash** (d6, *bulky*). Can be used in place of a shield in melee combat (+1 Armor). |
| **5** | **Striped Bamboo** (d6). Collapsible, it only requires one inventory slot (but still requires both hands). |
