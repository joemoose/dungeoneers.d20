...
In any outcome, the **player** who rolls the check chooses which complications are avoided.

- If the player **rolls their attribute score exactly**, a critical success, they **avoid all** the complications, regardless of how many you put in front of them.
- They can avoid **three** complications if they successfully roll **within 2** of their score.
- Any other successful roll avoids **two** complications.
...
| :-- | :-- | 
| Failure | You don’t achieve what you were attempting. |
| Delay | You take more time than you expected. |
...
| Complication | Description |
| :-- | :-- | 
| Breakage | A tool or other equipment you use for the action is broken. |
| Defeat | You are defeated and probably grievously injured or near death. |
| Enimity | You antagonize someone or something present, possibly creating new or increased hostilities. |
| Inaccuracy | Your actions affect one or more persons or things you did not intend to affect. |
| Mishap | Unpredictable or unusual setbacks occur. These effects might be lingering or momentary.
| Peril | A new threat enters the scene, or an existing one becomes more hazardous. |
...
| Complication | Description |
| :-- | :-- | 
| Affliction | You are poisoned, on fire, diseased, or otherwise afflicted with something that causes ongoing harm. |
| Burdens | You are weighed down by your goods, troubles, or obligations and may suffer. |
| Ensorcelment | You are subjected to some controlling or transformative effect. |
| Fear | You suffer intense fear and may struggle with even usual activities. |
| Helplessness | You are caught or held and require assistance getting loose or free. |
| Hunger | You suffer from deprivation, hunger, thirst, or other deep need that must be satisfied. |
...
- **Relocation**: “Sorry, you land amid the brawl.”
...
- **Enmity**: “You can never show your face again in the neighboring village.”
...
- **Expense**: “You use up a lot of rations as you search for the exit.”
- **Snares**: “Brambles grow into and through your pack and clothes. You hear something big coming your way.”
...
- **Failure**: “Your spear missed the monster. But, you did land on its back.”
...
- **Inaccuracy**: “Whoops. You ignite parts of town around the horde.”
...
- **Failure**: Generally, failure means you don't affect, trip, or escape from the monster, etc.
- **Forfeit**: Some monsters provide obvious opportunities to disarm, strip away their defenses, or trip them up in other ways. If missed, that opportunity is no longer available.
- **Breakage**: There are monsters with iron hides, ones whose touch rots leather or rusts metal. Such monsters present this complication.
- **Peril**: Monsters that cause chaos or damage can include this trait; creatures with acid for blood are especially likely to create perils if not fought with care.
- **Inaccuracy**: Some monsters move tactically, slipping between allies and around dangerous or valuable features or even teleporting away, so attacks can land badly, and players may end up hitting each other or things they care about.
- **Snares**: Attacks as simple as grabbing a character can present this complication, but it's especially appropriate for constricting monsters or those with writhing vines or tentacles.
- **Enmity**: Some monsters focus on one target at a time or reserve their unique abilities for those that anger them most; such creatures often have this complication. Other monsters can call upon or summon allies, presenting this complication differently.
- **Relocation**: Monsters that fling their foes around with brute physical force, gusts of breath, weather control, or magic all present this complication.
- **Defeat**: There are monsters whose merest touch is grievous harm. This is a fairly serious thing to use in most gameplay scenarios, but it can be appropriate. If the players know that complication is possible, they can plan accordingly.
- **Injury**: The majority of monsters have some ability to bite, claw, stab, or otherwise injure characters.
- **Affliction**: Venom, fire breath, and zombie plague attacks are all monstrous attacks that can create afflictions.
- **Burdens**: Any ability that drains vitality might be a good candidate for this complication.
- **Fear**: Some monsters are deadly largely because their victims often panic while encountering them; this might be a good complication if a monster is horrifying or otherworldly enough.
