...
!!! Note
		...
		Attacks from some creatures or spells might damage other attributes besides STR. A critical damage roll is still required, though against the damaged attribute and not STR.
