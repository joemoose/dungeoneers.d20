...
| 17 | You can only enter a home when invited or cross over running water if carried. |
...
As you become more corrupted, eldritch deities of primal chaos begin to notice and take an interest in you. When you suffer a vitiation from a failed corruption check, refer to the following tables for the effect.

#### Transmogrification

After suffering a **fifth vitiation** of the same type, you are forever transformed into a vile servant of chaos. You become an immediate threat to your adventuring party and a long-term threat to the world. The GM takes over your character. It’s time to create a new adventurer.
