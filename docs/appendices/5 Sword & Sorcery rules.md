...
You can see an [essence] number of creatures’ souls as long as you concentrate exclusively on the observation and do not move. This allows you to sense the approximate location of invisible creatures. You can also immediately sense if a person is possessed, undead, protected by the gods, lying, a spellcaster, or in other metaphysiological states.
...
When a character’s HP is reduced to zero or less, they are uniquely scarred. Look up the result in the table below based on the total amount of damage suffered:

| Damage | Scar |
| :-: | :- |
| 1 | **Lasting Scar**: Roll 1d6; 1: Neck, 2: Hands, 3: Eye, 4: Chest, 5: Legs, 6: Ear. Roll 2d4. If the total is higher than your max HP, swap it. |
| 2 | **Rattling Blow**: You’re disoriented and shaken. WIL Saves have Disadvantage until you heal and rest. Roll 2d4. If the total is higher than your max HP, swap it. |
| 3 | **Walloped**: You’re sent flying, landing flat on your face, winded. Add a Fatigue to your inventory. Add 1 to your max HP. |
| 4 | **Broken Limb**: Roll 1d6; 1-2: Leg, 3-4: Arm, 5: Rib, 6: Skull. STR Saves have DisD until you heal and rest. Once mended, roll 4d4. If the total is higher than your max HP, swap it. |
| 5 | **Diseased**: You have a revolting, uncomfortable infection. Saves have Disadvantage until you heal and rest. When you get over the infection, roll 4d4. If the total is higher than your max HP, swap it. |
...
| 7 | **Hamstrung**: You can’t walk until you heal and rest. After recovery, roll 3d6. If the result is higher than your STR Score, swap it. |
| 8 | **Deafened**: You cannot hear anything until you heal and rest. Afterward, Roll 3d6. If the result is higher than your WIL Score, swap it. |
...
Some relics require your character to bond with them before their magical properties can be used. This bond is called attunement, and certain items have a prerequisite for attuning, such as attuning in a temple or underground.
