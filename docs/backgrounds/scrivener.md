...
| **3** | **A Treatise on the Abyss**. A non-descript black book. An in-depth, largely theoretical text describing the **Underdark** and information about the location of a nearby **Gateway**. |
...
| **6** | **Garden of Glass**. Bound in the cover of another book. A heretical work that describes the materials, procedures, and optimal locations required to open a **Gate** to the **Underdark**. |
