...
- Rations (3 uses)
- Torch (3 uses) 
- *Strands of Ensnarement* Spell Tablet 
- Iron Dagger (d6)
- Herbs Pouch (restore 1 attribute loss, 3 uses)
- Ghillie Suit

## What did you bring back from the Unseen Court?
...
| **4** | A **Raven Familiar** [3 HP, 3 STR, 11 DEX, 13 WIL, beak, (d6)]. It speaks as an intelligent being and is entirely devoted to you. |
