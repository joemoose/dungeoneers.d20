...
| **2** | As a convict, the Oath was simply a means of avoiding punishment. Take **Lockpicks** and the key to a safehouse (_small_). |
| **3** | Noble-born, you joined to escape family trouble. Take a **Goosefelt Tarp** (fits two) you stole before leaving home. |
...
| d6 | Symbol | Description |
| :-: | - | - |
| **1** | **Impressive Pin** | A metal badge of honor from the Guard. It can open doors but leaves a trail. _Small_. |
...
| **3** | **Pullstones** | Two jet-black stones. When separated, the stones will always roll toward the other. |
...
| **5** | **Pain Band** | Touch an injured creature to transfer their wounds to you (exchange their lost STR with your own). **Recharge**: Wear the ring while in perfect health. It will take 1 STR, permanently. _Small_. |
