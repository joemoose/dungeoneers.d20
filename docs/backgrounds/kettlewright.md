...
| d6 | Trade |
| :-: | - |
| **1** | You build small contraptions for local guilds (and don't ask too many questions). Take an extra 40 coins and a wanted poster with your face on it. Given time and materials, _you can open almost any door or vault_. |
| **2** | You deal in home goods and tools, hawking your wares to townspeople across the lands. Take 20 coin worth of items from the gear table. You are fluent in the _Traveller's Cant_. |
...
| **4** | You sell rare and quality items to monasteries and nobles alike. Take a **Spyglass**, a **Necklace** (_petty_) worth 20 coins, and a **Scroll** of Mirrorwalk (_small_). |
