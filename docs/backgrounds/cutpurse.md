...
| **4** | Moneylender. Someone beat you to the job but left behind a **Scroll** of _Arcane Eye_ (*small*). |
...
| **5** | **Vagrant's Veil** | 1 charge. Wear it to blend seamlessly into crowds, appearing as a simple pauper. **Recharge**: Donate the day's winnings to the poor. _Small_ |
| **6** | **Smokestack Marble** | 3 uses. Crush to release a dense cloud of smoke that follows you. _Small_. |
