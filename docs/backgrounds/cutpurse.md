...
| d6 | Job |
| :-: | - |
| **1** | A noble's summer home. The place was full of fancy wine (+20 coins) but not much else. Take **Fence Cutters**. |
...
| **4** | Moneylender. Someone beat you to the job but left behind a **Scroll** of *Arcane Orb* (*small*). |
...
| **2** | **Gildfinger** | 1 charge. A finger glove that mimics any mundane key. **Recharge**: bundle it with at least 100 coins for a night. |
| **3** | **Glimpse Glass** | 3 charges. A monocle that lets you see through walls or doors. It shatters after the last use. |
...
| **5** | **Vagrant's Veil** | 1 charge. Wear it to blend seamlessly into crowds, appearing as a simple pauper. **Recharge**: Donate the day's winnings to the poor. *Small* |
