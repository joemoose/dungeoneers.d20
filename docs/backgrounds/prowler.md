...
| **3** | A _silver marsh crawler_ that killed someone close to you. You now carry its **Tooth** (_small_) on a chain around your neck as a warning to others of its kind. _The tooth hums softly when something is stalking you_. |
| **4** | A malicious _forest spirit_ that poisoned a homestead. You saved a **Heartseed** from the roots of a dying tree (plant to create a new forest). Also, take **Iron Bracers** (+1 Armor, _bulky_). 
...
| **6** | An _azure warbler_. The gametes attract a sizeable profit if properly extracted. You succeeded but left its nest to the wolves. Take a **Paring Knife** (d4), **an extra 20 coins**, and a pang of regret. |
...
| **6** | **Hardening Glue** | Makes any flat material (cloth, leather, sand) as hard as stone. Expensive (20 coins a bottle, 3 uses). |
