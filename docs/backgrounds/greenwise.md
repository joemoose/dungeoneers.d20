...
- Iron Pot
- Root Knife (d6)
- Healing Salve (restore 4 STR or DEX)
- Twine Bauble (_small_, _Ward_ once per day)<br>
...
| **5** | **Seed Bomb** | A canvas sack that explodes on impact, scattering seeds. d6 damage (_blast_). 3 uses. |
